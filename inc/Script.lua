...
local function ijeam(msg,MsgText)
...
if msg.Director 
and (redis:get(jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jeam..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
...
if not redis:get(jeam..'group:add'..msg.chat_id_) then return '🛠*¦* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:get(jeam..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(jeam..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
sendMsg(arg.chat_id_,data.id_,'📛¦ لا يمكنني عرض صورة بروفايلك لانك قمت بحظر البوت ... !\n\n')
  ...
  GetPhotoUser(data.id_,function(arg,data)
    local edited = (redis:get(jeam..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
    ...
    ..'💬¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(jeam..":infoiduser_public:"..arg.chat_id_) or redis:get(jeam..":infoiduser")  

if Kleshaidinfo then 
  local points = redis:get(jeam..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
  ...
  if redis:get(jeam.."idphoto"..msg.chat_id_) then
...
local GroupName = (redis:get(jeam..'group:name'..arg.ChatID) or '')
redis:set(jeam..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(jeam..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(jeam..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not msg.Director and redis:get(jeam..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif redis:sismember(jeam..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المطور\n🛠") 
elseif redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(jeam..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(jeam..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(jeam..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد الادمن\n🛠") 
elseif  redis:sismember(jeam..'whitelist:'..arg.ChatID,UserID) then 
...
elseif redis:sismember(jeam..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(jeam..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك نقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(jeam..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(jeam..'admins:'..msg.chat_id_,UserID) then 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(jeam..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  مميز في المجموعة. \n✓") 
else
redis:hset(jeam..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jeam..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jeam..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  مميز في المجموعة. \n✓") 
end
redis:hset(jeam..'username:'..UserID,'username',UserName)
redis:sadd(jeam..'whitelist:'..arg.ChatID,UserID)
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jeam..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ مميز في المجموعة \n✓️") 
else
redis:srem(jeam..'whitelist:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jeam..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ مميز في المجموعة \n✓️") 
else
redis:srem(jeam..'whitelist:'..arg.ChatID,UserID)
...
if redis:sismember(jeam..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  مدير في المجموعة. \n✓") 
else
redis:hset(jeam..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jeam..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(jeam..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  مدير في المجموعة. \n✓") 
else
redis:hset(jeam..'username:'..UserID, 'username',UserName)
redis:sadd(jeam..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(jeam..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ مدير في المجموعة \n✓️") 
else
redis:srem(jeam..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(jeam..'owners:'..arg.ChatID,UserID) then 
  sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ مدير في المجموعة \n✓️") 
else
redis:srem(jeam..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم تنزيل ❲ "..NameUser.." ❳ مدير في المجموعة \n✓️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
  return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
else
redis:hset(jeam..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jeam..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,UserID) then 
  return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
else
redis:hset(jeam..'username:'..UserID,'username',UserName)
redis:sadd(jeam..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم رفع  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
else
redis:srem(jeam..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,UserID) then 
  return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
else
redis:srem(jeam..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮 » تم تنزيل  ❲ "..NameUser.." ❳  منشئ في المجموعة \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(jeam..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
else
redis:hset(jeam..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jeam..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(jeam..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
else
redis:hset(jeam..'username:'..UserID,'username',UserName)
redis:sadd(jeam..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(jeam..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
else
redis:srem(jeam..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jeam..'admins:'..arg.ChatID,UserID) then 
  sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
else
redis:srem(jeam..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم تنزيل ❲ "..NameUser.." ❳ ادمن في المجموعة \n✓️") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(jeam..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(jeam..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(jeam..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(jeam..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(jeam..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(jeam..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if not MsgText[2] and msg.reply_id then 
  ...
  GetUserID(UserID,function(arg,data)
    Restrict(arg.ChatID,arg.UserID,2)
    redis:srem(jeam..'banned:'..arg.ChatID,arg.UserID)
    StatusLeft(arg.ChatID,arg.UserID)
    redis:srem(jeam..'is_silent_users:'..arg.ChatID,arg.UserID)
    NameUser = Hyper_Link_Name(data)
  ...
  local UserID = data.id_
  Restrict(arg.ChatID,UserID,2)
  redis:srem(jeam..'banned:'..arg.ChatID,UserID)
  StatusLeft(arg.ChatID,UserID)
  redis:srem(jeam..'is_silent_users:'..arg.ChatID,UserID)
  NameUser = Hyper_Link_Name(data)
  sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم رفع القيود ان وجد\n✓") 
  end,{ChatID=msg.chat_id_,MsgID=msg.id_})
  elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(jeam.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n🚶" end
...
GetUserID(arg.UserID,function(arg,data)
  NameUser = Hyper_Link_Name(data)
  USERNAME = ResolveUserName(data)
if redis:sismember(jeam..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد حظره من المجموعة\n✓") 
end

redis:hset(jeam..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jeam..'banned:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jeam..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد حظره من المجموعة\n✓") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(jeam..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(jeam..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم حظره من المجموعة\n✓") 
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(jeam..'username:'..arg.UserID,'username',USERNAME)
redis:setex(jeam..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(jeam..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(jeam..'username:'..UserID,'username',arg.USERNAME)
redis:setex(jeam..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(jeam..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📇|  » حسننا الان ارسل صلاحيات المشرف :\n\n|1- صلاحيه تغيير المعلومات\n|2- صلاحيه حذف الرسائل\n|3- صلاحيه دعوه مستخدمين\n|4- صلاحيه حظر وتقيد المستخدمين \n|5- صلاحيه تثبيت الرسائل \n|6- صلاحيه رفع مشرفين اخرين\n\n|[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n|[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n🚸| يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n| 136 جيم\n📬") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(jeam..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jeam..'banned:'..arg.ChatID,UserID) then 
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(jeam..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد كتمه من المجموعة\n✓") 
else
redis:hset(jeam..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jeam..'is_silent_users:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jeam..'is_silent_users:'..arg.ChatID,UserID) then 
  sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد كتمه من المجموعة\n✓") 
else
redis:hset(jeam..'username:'..UserID,'username',UserName)
redis:sadd(jeam..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم كتمه من المجموعة\n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(jeam..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jeam..'is_silent_users:'..arg.ChatID,UserID) then 
  sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد الغاء كتمه من المجموعة\n✓") 
else
redis:srem(jeam..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم الغاء كتمه من المجموعة\n✓") 
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end 
redis:setex(jeam..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل  رابط مجموعتك 🍃'
end

if MsgText[1] == "انشاء رابط" then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(jeam..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(jeam..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(jeam..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(jeam.."lock_linkk"..msg.chat_id_) then return "📡*¦* الامر معطل من قبل الادارة \n^"  end
if not redis:get(jeam..'linkGroup'..msg.chat_id_) then return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
local GroupName = redis:get(jeam..'group:name'..msg.chat_id_)
local GroupLink = redis:get(jeam..'linkGroup'..msg.chat_id_)
return "🔖¦رابـط الـمـجـمـوعه 💯\n🌿¦ "..Flter_Markdown(GroupName).." :\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jeam..'rulse:witting'..msg.sender_user_id_,300,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل القوانين  للمجموعه 🍃'
end

if MsgText[1] == "القوانين" then
if not redis:get(jeam..'rulse:msg'..msg.chat_id_) then 
return "📡*¦* مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه\n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n"
else 
return "*🔖¦القوانين :*\n"..redis:get(jeam..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(jeam..'flood'..msg.chat_id_,MsgText[2]) 
...
local Admins = redis:scard(jeam..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓" 
end
redis:del(jeam..':MONSHA_Group:'..msg.chat_id_)
...
local Admins = redis:scard(jeam..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(jeam..'admins:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦ تم مسح {"..Admins.."} من الادمنيه في البوت \n✓"
end
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Mn3Word = redis:scard(jeam..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(jeam..':Filter_Word:'..msg.chat_id_)
...
redis:del(jeam..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(jeam..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(jeam..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
local NumMnsha = redis:scard(jeam..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(jeam..':MONSHA_BOT:'..msg.chat_id_)
...
local NumMDER = redis:scard(jeam..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(jeam..'owners:'..msg.chat_id_)
...
local list = redis:smembers(jeam..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌¦ لا يوجد مستخدمين محظورين  *" end
message = '📋*¦* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(jeam..'banned:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MKTOMEN = redis:scard(jeam..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(jeam..'is_silent_users:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MMEZEN = redis:scard(jeam..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(jeam..'whitelist:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MMEZEN.." *} من المميزين  \n✓"
end

if MsgText[2] == 'الرابط' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(jeam..'linkGroup'..msg.chat_id_) then 
return "*⚙️*¦ لا يوجد رابط مضاف اصلا " 
end
redis:del(jeam..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jeam..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(jeam..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jeam..'about:witting'..msg.sender_user_id_,300,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الوصف  للمجموعه\n🛠" 
end

if MsgText[1] == "تاك للكل" then 
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(jeam.."lock_takkl"..msg.chat_id_) then  return "📛*¦* الامر معطل من قبل الادراة" end 
return TagAll(msg) 
end
...
if redis:sismember(jeam..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"📝*¦* هي بالتأكيد في قائمه المنع✓️")
else
redis:sadd(jeam..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(jeam..':Filter_Word:'..arg.ChatID,Type_id) then 
  redis:srem(jeam..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(jeam..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(jeam..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(jeam..'owners:'..arg.ChatID,v.user_id_)
redis:srem(jeam..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(jeam..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(jeam..'CheckExpire::'..msg.chat_id_) then 
redis:set(jeam..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(jeam..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if MsgText[2] == '1' then
redis:setex(jeam..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(jeam..'CheckExpire::'..msg.chat_id_) then 
redis:set(jeam..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(jeam..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(jeam..'CheckExpire::'..msg.chat_id_) then 
redis:set(jeam..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(jeam..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(jeam..'CheckExpire::'..msg.chat_id_) then 
redis:set(jeam..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
local check_time = redis:ttl(jeam..'ExpireDate:'..msg.chat_id_)
...
Getrtb = 'مطور اساسي ' 
elseif redis:sismember(jeam..':SUDO_BOT:',arg.UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(jeam..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(jeam..'owners:'..arg.ChatID,arg.UserID) then
Getrtb = 'المدير ' 
elseif redis:sismember(jeam..'admins:'..arg.ChatID,arg.UserID) then
Getrtb = 'ادمن' 
elseif redis:sismember(jeam..'whitelist:'..arg.ChatID,arg.UserID) then
Getrtb = 'مميز' 
else
Getrtb = 'عضو' 
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(jeam..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(jeam..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(jeam..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(jeam..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(jeam..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(jeam..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(jeam..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(jeam..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(jeam..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ » 【'..(redis:get(jeam..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n🐾'
end
...
SUDO_USER = redis:hgetall(jeam..'username:'..SUDO_ID).username
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:set(jeam..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(jeam..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(jeam..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."  \n🌿¦ نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
if MsgText[1] == "رفع منشئ اساسي" or MsgText[1] == "رفع منشى اساسي" then
  ...
  ReUsername = ResolveUserName(data)
  NameUser = Hyper_Link_Name(data)
  if redis:sismember(jeam..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
  ...
  redis:hset(jeam..'username:'..arg.UserID,'username',ReUsername)
  redis:sadd(jeam..':MONSHA_Group:'..arg.ChatID,arg.UserID)
  end
  end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
  end,{ChatID=msg.chat_id_,MsgID=msg.id_})
  end
  ...
  local UserID = data.id_
  NameUser = Hyper_Link_Name(data)
  if redis:sismember(jeam..':MONSHA_Group:'..arg.ChatID,UserID) then 
  sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد رفع ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
  else
  redis:hset(jeam..'username:'..UserID,'username',arg.UserName)
  redis:sadd(jeam..':MONSHA_Group:'..arg.ChatID,UserID)
  sendMsg(arg.ChatID,arg.MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
  end
  end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
  end 
  ...
  if MsgText[1] == "تنزيل منشئ اساسي" or MsgText[1] == "تنزيل منشى اساسي" then
    ...
    if not redis:sismember(jeam..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
    ...
    redis:srem(jeam..':MONSHA_Group:'..arg.ChatID,arg.UserID)
    end  
    end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
    end,{ChatID=msg.chat_id_,MsgID=msg.id_})
    end
    ...
    UserName = Flter_Markdown(arg.UserName)
    NameUser = Hyper_Link_Name(data)
    if not redis:sismember(jeam..':MONSHA_Group:'..arg.ChatID,UserID) then 
    sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️") 
    else
    redis:srem(jeam..':MONSHA_Group:'..arg.ChatID,UserID)
    sendMsg(arg.ChatID,arg.MsgID,"📮 » تم تنزيل ❲ "..NameUser.." ❳ منشئ اساسي في المجموعة \n✓️")
    end
    end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
    end 
...
if MsgText[1] == 'مسح كليشه الايدي' or MsgText[1] == 'مسح الايدي' or MsgText[1] == 'مسح ايدي'  or MsgText[1] == 'مسح كليشة الايدي'  then 
  ...
  redis:del(jeam..":infoiduser_public:"..msg.chat_id_)
...
if MsgText[1] == 'تعيين كليشه الايدي' or MsgText[1] == 'تعيين الايدي' or MsgText[1] == 'تعيين ايدي'  or MsgText[1] == 'تعيين كليشة الايدي'  then 
  if not msg.Creator then return "📛*¦* هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n🚶" end
  redis:setex(jeam..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
if MsgText[1] == "تنزيل الكل" then
  if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
    ...
    UserID = msg.UserID
      ...
      elseif redis:sismember(jeam..'admins:'..msg.chat_id_,UserID) then 
      rinkuser = 6
      elseif redis:sismember(jeam..'whitelist:'..msg.chat_id_,UserID) then 
      rinkuser = 7
      else
      rinkuser = 8
      end
      local DonisDown = "\n📛| تم تنزيله من الرتب الاتيه : \n\n "
     if redis:sismember(jeam..':SUDO_BOT:',UserID) then 
      DonisDown = DonisDown.."⭕️| تم تنزيله من المطور ✓️\n"
     end 
     if redis:sismember(jeam..':MONSHA_Group:'..msg.chat_id_,UserID) then 
      DonisDown = DonisDown.."⭕️| تم تنزيله من المنشئ الاساسي ✓️\n"
    end 
    if redis:sismember(jeam..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
      DonisDown = DonisDown.."⭕️| تم تنزيله من المنشئ ✓️\n"
    end 
    if redis:sismember(jeam..'owners:'..msg.chat_id_,UserID) then 
      DonisDown = DonisDown.."⭕️| تم تنزيله من المدير ✓️\n"
    end 
    if redis:sismember(jeam..'admins:'..msg.chat_id_,UserID) then 
      DonisDown = DonisDown.."⭕️| تم تنزيله من الادمن ✓️\n"
    end 
    if redis:sismember(jeam..'whitelist:'..msg.chat_id_,UserID) then
...
huk = false
    if msg.SudoBase then 
      redis:srem(jeam..':SUDO_BOT:',UserID)
      redis:srem(jeam..':MONSHA_Group:'..msg.chat_id_,UserID)
      redis:srem(jeam..':MONSHA_BOT:'..msg.chat_id_,UserID)
      redis:srem(jeam..'owners:'..msg.chat_id_,UserID)
      redis:srem(jeam..'admins:'..msg.chat_id_,UserID)
      redis:srem(jeam..'whitelist:'..msg.chat_id_,UserID)
...
if MsgText[1] == "قائمه الاوامر" then
  if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
  local list = redis:hgetall(jeam..":AwamerBotArray2:"..msg.chat_id_)
  local list2 = redis:hgetall(jeam..":AwamerBotArray:"..msg.chat_id_)
...
if MsgText[1] == "مسح الاوامر" then
  if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
  local Awammer 	= redis:del(jeam..":AwamerBot:"..msg.chat_id_)
  redis:del(jeam..":AwamerBotArray:"..msg.chat_id_)
  redis:del(jeam..":AwamerBotArray2:"..msg.chat_id_)
  if Awammer ~= 0 then
...
for k, jeam in pairs(Xjeam) do if MsgText[2]:match(jeam) then  checkAmr = true end end      
if checkAmr then
redis:setex(jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶"
end
else
redis:setex(jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if MsgText[2] then
local checkk = redis:hdel(jeam..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(jeam..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
for Amor,ik in pairs(AmrOld) do
  ...
  redis:hdel(jeam..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(jeam..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(jeam..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if MsgText[1] == 'تعيين قائمه الاوامر' then 
  redis:setex(jeam..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(jeam..':SUDO_BOT:',arg.UserID) then 
...
redis:hset(jeam..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(jeam..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(jeam..'username:'..UserID,'username',ReUsername)
redis:sadd(jeam..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم رفع ❲ "..NameUser.." ❳  مطور في البوت \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jeam..':SUDO_BOT:',arg.UserID) then 
...
redis:srem(jeam..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jeam..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم بالتأكيد تنزيل  ❲ "..NameUser.." ❳  مطور في البوت \n✓") 
else
redis:srem(jeam..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮 » تم تنزيل ❲ "..NameUser.." ❳  مطور في البوت \n✓") 
...
local groups = redis:smembers(jeam..'group:ids')
...
local pv = redis:smembers(jeam..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(jeam..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(jeam..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(jeam..':NameBot:')..[[ 🎖
...
redis:setex(jeam..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭¦ حسننا عزيزي 🍁\n💬¦ الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(jeam..':addnumberusers',MsgText[2]) 
return '💱*¦* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*¦* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(jeam..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
return '📮*¦* عدد المجموعات المفعلة » `'..redis:scard(jeam..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not redis:get(jeam.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n🚶" end
redis:setex(jeam..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '📮*¦* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n➼' 
end
...
return redis:get(jeam..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه بالتثبيت" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jeam..'lock_brod') then return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" end
redis:setex(jeam..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "📭¦ حسننا الان ارسل رساله ليتم اذاعتها بالتثبيت  \n🔛" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jeam..'lock_brod') then 
return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(jeam..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(jeam..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(jeam..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(jeam..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:hset(jeam..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jeam..'gban_users',arg.UserID)
...
if redis:sismember(jeam..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳  تم بالتأكيد حظرة عام من المجموعة\n✓") 
else
redis:hset(jeam..'username:'..UserID,'username',UserName)
redis:sadd(jeam..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(jeam..'gban_users',arg.UserID)
...
if not redis:sismember(jeam..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳ تم بالتأكيد الغاء حظره العام  \n✓") 
else
redis:srem(jeam..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📌 » العضو ❲ "..NameUser.." ❳ تم الغاء حظره العام  \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(jeam..'welcom:witting'..msg.sender_user_id_,
jeam..'rulse:witting'..msg.sender_user_id_,
jeam..'rulse:witting'..msg.sender_user_id_,
jeam..'name:witting'..msg.sender_user_id_,
jeam..'about:witting'..msg.sender_user_id_,
jeam..'fwd:all'..msg.sender_user_id_,
jeam..'fwd:pv'..msg.sender_user_id_,
jeam..'fwd:groups'..msg.sender_user_id_,
jeam..'namebot:witting'..msg.sender_user_id_,
jeam..'addrd_all:'..msg.sender_user_id_,
jeam..'delrd:'..msg.sender_user_id_,
jeam..'addrd:'..msg.sender_user_id_,
jeam..'delrdall:'..msg.sender_user_id_,
jeam..'text_sudo:witting'..msg.sender_user_id_,
jeam..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
jeam..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
jeam..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_,
jeam..':KStart:'..msg.chat_id_..msg.sender_user_id_,
jeam.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
jeam..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
jeam..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
jeam..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
return '👨🏾‍🔧¦ اصدار سورس جيم : *v'..version..'* \n📡'
end
 
if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://uuu0q.github.io/GetVersion.txt') or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...')
redis:set(jeam..":VERSION",GetVerison)
return false
else
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس جيم يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : جـيـم 🍃",url="t.me/uuu0q"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : جـيـم](t.me/uuu0q)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📈" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..redis:scard(jeam..'group:ids')..'\n👤*¦* عدد المشتركين في البوت : '..redis:scard(jeam..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(jeam..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jeam..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
return "📭¦ حسننا الان ارسل كليشة الستارت \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n ."
end
if MsgText[1] == "مسح كليشه الستارت" or MsgText[1] == "مسح كليشة الستارت"  then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:del(jeam..':Text_Start')
return "📭¦ تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names 	= redis:exists(jeam..'replay:'..msg.chat_id_)
local photo 	= redis:exists(jeam..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(jeam..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(jeam..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(jeam..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(jeam..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(jeam..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(jeam..'replay:'..msg.chat_id_,jeam..'replay_photo:group:'..msg.chat_id_,jeam..'replay_voice:group:'..msg.chat_id_,
jeam..'replay_animation:group:'..msg.chat_id_,jeam..'replay_audio:group:'..msg.chat_id_,jeam..'replay_sticker:group:'..msg.chat_id_,jeam..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(jeam..'replay:all')
local photo 	= redis:exists(jeam..'replay_photo:group:')
local voice 	= redis:exists(jeam..'replay_voice:group:')
local imation 	= redis:exists(jeam..'replay_animation:group:')
local audio 	= redis:exists(jeam..'replay_audio:group:')
local sticker 	= redis:exists(jeam..'replay_sticker:group:')
local video 	= redis:exists(jeam..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(jeam..'replay:all',jeam..'replay_photo:group:',jeam..'replay_voice:group:',jeam..'replay_animation:group:',jeam..'replay_audio:group:',jeam..'replay_sticker:group:',jeam..'replay_video:group:')
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:set(jeam..'delrdall:'..msg.sender_user_id_,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:set(jeam..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names  	= redis:hkeys(jeam..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(jeam..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(jeam..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(jeam..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(jeam..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(jeam..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(jeam..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(jeam..'replay:all')
local photo 	= redis:hkeys(jeam..'replay_photo:group:')
local voice 	= redis:hkeys(jeam..'replay_voice:group:')
local imation 	= redis:hkeys(jeam..'replay_animation:group:')
local audio 	= redis:hkeys(jeam..'replay_audio:group:')
local sticker 	= redis:hkeys(jeam..'replay_sticker:group:')
local video 	= redis:hkeys(jeam..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:setex(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(jeam..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jeam..'namebot:witting'..msg.sender_user_id_,300,true)
...
if msg.type == 'channel' and msg.GroupActive then
  ...
  if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(jeam..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
    redis:del(jeam..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
    redis:setex(jeam..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jeam..":awamer_Klesha_m:") or text
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_m1:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_m2:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_m3:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_mtwr:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_mrd:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
  msg = arg.msg
  local textD = redis:get(jeam..":awamer_Klesha_mf:") or text
  textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
  sendMsg(msg.chat_id_,msg.id_,textD)
  end,{msg=msg})
  return false
...
if not redis:get(jeam.."lock_leftgroup"..msg.chat_id_) then  return "📛*¦* امر المغادره معطل من قبل اداره المجموعة  \n🚶" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"👨🏼‍⚕️| اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n🔖| اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n🔖¦فهذا رابط المجموعه 💯\n🌿¦"..Flter_Markdown(redis:get(jeam..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(jeam..'linkGroup'..msg.chat_id_).."]\n")
...
`git clone https://github.com/th3jeam/jeam ;cd jeam;chmod +x ins;./ins`
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://th3jeam.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/th3jeam/jeam/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
if redis:get(jeam..":UserNameChaneel") then
return "📑| اهلا عزيزي المطور \n🔖| الاشتراك بالتأكيد مفعل"
else
redis:setex(jeam..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local SubDel = redis:del(jeam..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local UserChaneel = redis:get(jeam..":UserNameChaneel")
if UserChaneel then
...
local function djeam(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(jeam..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(jeam..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(jeam..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(jeam..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(jeam..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(jeam..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
  if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(jeam..':Text_Start') or text
local edited = (redis:get(jeam..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(jeam..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(jeam..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local MSG_ID = (redis:get(jeam.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if not redis:get(jeam..'lock_twasel') then
...
redis:setex(jeam.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group =====================================
if redis:get(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(jeam..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(jeam..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(jeam..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
redis:hset(jeam..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
redis:hset(jeam..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(jeam..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(jeam..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(jeam..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(jeam..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(jeam..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(jeam..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(jeam..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(jeam..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(jeam..'replay:all',klma,Flter_Markdown(msg.text))
...
redis:hset(jeam..'replay_photo:group:',klma,photo_id)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(jeam..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(jeam..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(jeam..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(jeam..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(jeam..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(jeam.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
  redis:del(jeam.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
  redis:set(jeam..'linkGroup'..msg.chat_id_,msg.text)
  sendMsg(msg.chat_id_,msg.id_,"🔖| تم تعيين الرابط بنجاح  ")
  return false
end

if msg.Creator and redis:get(jeam..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
  redis:del(jeam..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
  redis:set(jeam..":infoiduser_public:"..msg.chat_id_,msg.text)
  sendMsg(msg.chat_id_,msg.id_,"🔖| تم تعيين كليشة الايدي بنجاح \n📮| يمكنك تجربة الامر الان ")
  return false
end

if msg.SuperCreator and redis:get(jeam..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

  NameUser = redis:get(jeam..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
  UserID = redis:get(jeam..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
  redis:del(jeam..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
  redis:del(jeam..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
  ...
  redis:sadd(jeam..'admins:'..msg.chat_id_,UserID)
  local trues = "✓"
  local falses = "✖️"
...
if msg.Creator and redis:get(jeam..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(jeam..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
 ...
 local amr = redis:get(jeam..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
 if amr == "م1" then
  redis:set(jeam..":awamer_Klesha_m1:",msg.text)
 elseif amr == "م2" then
  redis:set(jeam..":awamer_Klesha_m2:",msg.text)
 elseif amr == "م3" then
  redis:set(jeam..":awamer_Klesha_m3:",msg.text)
 elseif amr == "م المطور" then
  redis:set(jeam..":awamer_Klesha_mtwr:",msg.text)
 elseif amr == "اوامر الرد" then
  redis:set(jeam..":awamer_Klesha_mrd:",msg.text)
 elseif amr == "اوامر الملفات" then
  redis:set(jeam..":awamer_Klesha_mf:",msg.text)
 elseif amr == "الاوامر" then
  redis:set(jeam..":awamer_Klesha_m:",msg.text)
 end
 redis:del(jeam..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔖| تم تعيين كليشة التعليمات بنجاح \n📮| يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(jeam..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
  redis:del(jeam..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
  redis:set(jeam..":infoiduser",msg.text)
  sendMsg(msg.chat_id_,msg.id_,"🔖| تم تعيين كليشة الايدي بنجاح \n📮| يمكنك تجربة الامر الان ")
  return false
end
...
if msg.Director and redis:get(jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
  local Awammer 	= redis:hgetall(jeam..":AwamerBotArray2:"..msg.chat_id_)
  Amr = redis:get(jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
  local checknewamr = false
  for k, jeam in pairs(Xjeam) do 
    local cceck,sec = jeam:gsub("[(]"..Amr.."[)]","("..msg.text..")")
    if sec ~= 0 then
    redis:hset(jeam..":AwamerBotArray:"..msg.chat_id_,cceck,jeam)
    redis:hset(jeam..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
    end
    end  
  ...
  redis:hset(jeam..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
  sendMsg(msg.chat_id_,msg.id_,"📑| تم تغيير الامر القديم ["..Amr.."] \n🔖| الى الامر الجديد ["..msg.text.."]\n...")
  end
  redis:del(jeam..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
  local Awammer 	= redis:hgetall(jeam..":AwamerBotArray2:"..msg.chat_id_)
  local Amr = redis:get(jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
  ...
  redis:del(jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, jeam in pairs(Xjeam) do if msg.text:match(jeam) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"📭¦ حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n| ارسل الامر الجديد الان \n...")
redis:setex(jeam..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶")
end
redis:del(jeam..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
if msg.Director and redis:get(jeam..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(jeam..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(jeam..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(jeam..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "📭¦ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "📛*¦* هذا الامر ليس موجود ضمن الاوامر المضافه  \n🚶"
...
if msg.SudoBase and redis:get(jeam..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
  if msg.text:match("^@[%a%d_]+$") then
      GetUserName(msg.text,function(arg,data)
        ...
        redis:set(jeam..":SUDO_ID:",UserID)
        local usero = arg.USERNAME:gsub([[\_]],"_")
        redis:hset(jeam..'username:'..UserID,'username',usero)
  ...
  redis:del(jeam..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
  return false 
end


if redis:get(jeam..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(jeam..":ForceSub:"..msg.sender_user_id_)
...
redis:set(jeam..":UserNameChaneel",msg.text)
...
if redis:get(jeam..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(jeam..'namebot:witting'..msg.sender_user_id_)
redis:set(jeam..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭¦ تم تغير اسم البوت  ✋🏿\n🗯¦ الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(jeam..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(jeam..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(jeam..'replay_photo:group:',msg.text)
redis:hdel(jeam..'replay_voice:group:',msg.text)
redis:hdel(jeam..'replay_animation:group:',msg.text)
redis:hdel(jeam..'replay_audio:group:',msg.text)
redis:hdel(jeam..'replay_sticker:group:',msg.text)
redis:hdel(jeam..'replay_video:group:',msg.text)
redis:setex(jeam..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n\n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n➼")
end
end

if redis:get(jeam..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(jeam..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(jeam..':Text_Start',msg.text)
...
if redis:get(jeam..'delrdall:'..msg.sender_user_id_) then
redis:del(jeam..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(jeam..'replay:all',msg.text)
local photo =redis:hget(jeam..'replay_photo:group:',msg.text)
local voice = redis:hget(jeam..'replay_voice:group:',msg.text)
local animation = redis:hget(jeam..'replay_animation:group:',msg.text)
local audio = redis:hget(jeam..'replay_audio:group:',msg.text)
local sticker = redis:hget(jeam..'replay_sticker:group:',msg.text)
local video = redis:hget(jeam..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(jeam..'replay:all',msg.text)
redis:hdel(jeam..'replay_photo:group:',msg.text)
redis:hdel(jeam..'replay_voice:group:',msg.text)
redis:hdel(jeam..'replay_audio:group:',msg.text)
redis:hdel(jeam..'replay_animation:group:',msg.text)
...
if redis:get(jeam..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(jeam..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(jeam..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(jeam..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(jeam..'welcom:witting'..msg.sender_user_id_) 
redis:set(jeam..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(jeam..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(jeam..'rulse:witting'..msg.sender_user_id_) 
redis:set(jeam..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(jeam..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(jeam..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(jeam..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(jeam..'about:witting'..msg.sender_user_id_) 
...
if redis:get(jeam..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(jeam..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(jeam..'users')  
local groups = redis:smembers(jeam..'group:ids')
...
if redis:get(jeam..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(jeam..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(jeam..'users')
if #pv >= 300 then
...
if redis:get(jeam..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jeam..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(jeam..'group:ids')
if #groups >= 300 then
...
redis:setex(jeam..":propin"..data.chat_id_,100,data.content_.text_)
end)
end
sendMsg(msg.chat_id_,msg.id_,'📑*¦* عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n🗣*¦* تـم الاذاعه بالتثبيت بنجاح ✓')
end 

if redis:get(jeam..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(jeam..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(jeam..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'📑| اهلا عزيزي المطور \n🔖| جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(jeam..'fwd:'..msg.sender_user_id_) then
redis:del(jeam..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(jeam..'users')
local groups = redis:smembers(jeam..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(jeam..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(jeam..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(jeam..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(jeam..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(jeam..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(jeam..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(jeam..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(jeam..'replay:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(jeam..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(jeam..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n➼")
end
end

if redis:get(jeam..'delrd:'..msg.sender_user_id_) then
redis:del(jeam..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(jeam..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(jeam..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(jeam..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(jeam..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(jeam..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(jeam..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(jeam..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(jeam..'replay:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(jeam..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(jeam..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(jeam..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(jeam..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(jeam..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(jeam..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(jeam..'welcome:get'..msg.chat_id_)
end
redis:setex(jeam..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(jeam..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(jeam..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(jeam..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(jeam..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(jeam..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(jeam..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
  gtupe = 'المطور الاساسي' 
  elseif redis:sismember(jeam..':SUDO_BOT:',msg.adduser) then 
  gtupe = 'المطور'
  elseif msg.GroupActive and redis:sismember(jeam..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
  gtupe = 'منشئ اساسي'
  elseif msg.GroupActive and redis:sismember(jeam..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
  gtupe = 'المنشىء'
  elseif msg.GroupActive and redis:sismember(jeam..'owners:'..msg.chat_id_,msg.adduser) then 
  gtupe = 'المدير' 
  elseif msg.GroupActive and redis:sismember(jeam..'admins:'..msg.chat_id_,msg.adduser) then 
  gtupe = 'الادمن'
  elseif msg.GroupActive and redis:sismember(jeam..'whitelist:'..msg.chat_id_,msg.adduser) then 
  gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(jeam..'group:name'..msg.chat_id_) or '')))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(jeam..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(jeam..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين  👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(jeam.."antiedit"..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_)
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(jeam..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(jeam..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(jeam..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(jeam..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(jeam..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
 
 
if msg.forward_info_ then
if redis:get(jeam..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(jeam..'lock_woring'..msg.chat_id_) and not redis:get(jeam..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(jeam..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(jeam..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(jeam..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(jeam..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(jeam..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(jeam..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(jeam..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(jeam..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(jeam..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(jeam.."lock_pharsi"..msg.chat_id_) then
  Del_msg(msg.chat_id_,msg.id_,function(arg,data)
    ...
    return false
elseif KlmatMmno3(msg.text) and redis:get(jeam.."lock_mmno3"..msg.chat_id_) then
  Del_msg(msg.chat_id_,msg.id_,function(arg,data)
    ...
    return false
elseif msg.text:match("[a-zA-Z]") and redis:get(jeam.."lock_lang"..msg.chat_id_) then
  Del_msg(msg.chat_id_,msg.id_,function(arg,data)
    ...
    return false
elseif msg.text:match("#.+") and redis:get(jeam..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(jeam..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(jeam..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(jeam..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(jeam..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(jeam..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jeam..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(jeam..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jeam..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(jeam..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(jeam..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(jeam..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jeam..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(jeam..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(jeam..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(jeam..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(jeam..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(jeam..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(jeam..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(jeam..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(jeam..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(jeam..'replay'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)
local Replay = false

Replay = redis:hget(jeam..'replay:all',msg.text)
if Replay then
...
Replay = redis:hget(jeam..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(jeam..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
return false
end

Replay = redis:hget(jeam..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jeam..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jeam..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jeam..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(jeam..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jeam..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(jeam..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(jeam..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(jeam..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(jeam..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(jeam..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jeam..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if redis:get(jeam..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(jeam..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(jeam..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
