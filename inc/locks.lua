...
#    $$ |   $$ |  $$ |$$ |\$  /$$ |
#    $$ |   $$ |  $$ |$$ | \_/ $$ |
#    \|   \__|  \__|\__|     \__|         ▀  ¦ Source TH3jeam BY @uuu0q
#---------------------------------------------------------------------
]]
...
if not redis:get(jeam.."lock_KickBan"..msg.chat_id_) then 
...
redis:del(jeam.."lock_KickBan"..msg.chat_id_) 
...
else redis:set(jeam.."idphoto"..msg.chat_id_,true)
...
else redis:set(jeam.."lock_woring"..msg.chat_id_,true)
...
redis:set(jeam.."lock_id"..msg.chat_id_,true)  
...
else redis:set(jeam.."welcome:get"..msg.chat_id_,true)  
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(jeam.."welcome:get"..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
jeam.."lock_username"..msg.chat_id_,true,
jeam.."mute_gif"..msg.chat_id_,true,
jeam.."mute_photo"..msg.chat_id_,true,
jeam.."mute_audio"..msg.chat_id_,true,
jeam.."mute_voice"..msg.chat_id_,true,
jeam.."mute_sticker"..msg.chat_id_,true,
jeam.."mute_forward"..msg.chat_id_,true,
jeam.."mute_contact"..msg.chat_id_,true,
jeam.."mute_location"..msg.chat_id_,true,
jeam.."mute_document"..msg.chat_id_,true,
jeam.."lock_link"..msg.chat_id_,true,
jeam.."lock_tag"..msg.chat_id_,true,
jeam.."lock_edit"..msg.chat_id_,true,
jeam.."lock_spam"..msg.chat_id_,true,
jeam.."lock_bots"..msg.chat_id_,true,
jeam.."lock_webpage"..msg.chat_id_,true,
jeam.."mute_video"..msg.chat_id_,true,
jeam.."mute_inline"..msg.chat_id_,true
)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
jeam.."lock_username"..msg.chat_id_,
jeam.."mute_gif"..msg.chat_id_,
jeam.."mute_photo"..msg.chat_id_,
jeam.."mute_audio"..msg.chat_id_,
jeam.."mute_voice"..msg.chat_id_,
jeam.."mute_sticker"..msg.chat_id_,
jeam.."mute_forward"..msg.chat_id_,
jeam.."mute_contact"..msg.chat_id_,
jeam.."mute_location"..msg.chat_id_,
jeam.."mute_document"..msg.chat_id_,
jeam.."lock_link"..msg.chat_id_,
jeam.."lock_tag"..msg.chat_id_,
jeam.."lock_edit"..msg.chat_id_,
jeam.."lock_spam"..msg.chat_id_,
jeam.."lock_bots"..msg.chat_id_,
jeam.."lock_webpage"..msg.chat_id_,
jeam.."mute_video"..msg.chat_id_,
jeam..":tqeed_video:"..msg.chat_id_,
jeam..":tqeed_photo:"..msg.chat_id_,
jeam..":tqeed_gif:"..msg.chat_id_,
jeam..":tqeed_fwd:"..msg.chat_id_,
jeam..":tqeed_link:"..msg.chat_id_,
jeam.."mute_inline"..msg.chat_id_
)
...
if redis:get(jeam..":tqeed_photo:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالصور بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(jeam.."mute_photo"..msg.chat_id_)
redis:set(jeam..":tqeed_photo:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(jeam..":tqeed_video:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالفيديو بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(jeam..":tqeed_video:"..msg.chat_id_)
redis:set(jeam..":tqeed_video:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(jeam..":tqeed_video:"..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(jeam..":tqeed_gif:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد الممتحركه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(jeam.."mute_gif"..msg.chat_id_)
redis:set(jeam..":tqeed_gif:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(jeam..":tqeed_fwd:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالتوجيه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(jeam.."mute_forward"..msg.chat_id_)
redis:set(jeam..":tqeed_fwd:"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(jeam.."lock_bots"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." البوتات بالتأكيد تم فتحها \n✓",16,utf8.len(msg.TheRankCmd)) 
else 
redis:del(jeam.."lock_bots_by_kick"..msg.chat_id_)
redis:del(jeam.."lock_bots"..msg.chat_id_)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(jeam.."mute_gif"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(jeam.."mute_game"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(jeam.."mute_photo"..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(jeam.."mute_forward"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(jeam.."lock_bots_by_kick"..msg.chat_id_) then
